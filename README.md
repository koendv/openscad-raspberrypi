...
The Dubois algorithm is applied to the pixels after rendering. This algorithm is applied to the colors before rendering. The result is a savings of tens of millions of multiplications and additions per frame.
